...
public class BooleanExpressions {
     ...
     *
     * colour.equalsIgnoreCase("red") && (numShoes >= 4) If the colour is not red
     * there is no way both expression can be true and as a result Java does not
     * look at the numShoes expression
     * 
     * 
     * colour.equalsIgnoreCase("blue") || (numShoes >= 4) If the colour is blue then
     * we don't to look at numShoes expression BECAUSE only 1 of the expressions has
     * to be true for OR
     * 
     */
