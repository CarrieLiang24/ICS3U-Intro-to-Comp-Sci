...
public class VariablesAndAssignmentOperator {
    ...
    private static void exampleOne() {
        ...
        int numberOne; //declare a variable called numberOne that referes to a primitive int
        numberOne = 10; //assignment operator -- reads as numberOne is assigned to 10
